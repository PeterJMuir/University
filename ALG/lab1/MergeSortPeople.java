...
public class MergeSortPeople  
{
   ...
   public static void main(String[] args) throws Exception
   {
      ...
      if (args.length != 2)
      {
         System.out.println("Usage: MergeSortPeople <input file> <output file>");
         System.exit(1);
      }
