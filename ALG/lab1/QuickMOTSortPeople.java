...
public class QuickMOTSortPeople
{
   /* Driver program
   ...
   public static void main(String[] args) throws Exception
   {
      ...
      if (args.length != 2)
      {
         System.out.println("Usage: QuickMOTSortPeople <input file> <output file>");
         System.exit(1);
      }
