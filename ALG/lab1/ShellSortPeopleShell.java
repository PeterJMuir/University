...
public class ShellSortPeopleShell
{
   /* Driver program
   ...
   public static void main(String[] args) throws Exception
   {
      ...
      if (args.length != 2)
      {
         System.out.println("Usage: ShellSortPeopleShell <input file> <output file>");
         System.exit(1);
      }
      ...
      Person.resetCounter(); 
      Sorter.ShellSort(people,0,people.size()-1,getShellIntervals(people.size()));
      System.out.println("There were " + Person.getCounter() +
                         " comparisons to sort " + people.size() + 
                         " people with Shell Sort (SHELL)");
