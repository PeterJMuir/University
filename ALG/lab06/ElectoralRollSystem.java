...
/*
   Replaced BufferedReader with Scanner class
   Replaced all BufferedReader calls, e.g. readLine( )
   with equivalent Scanner class calls, e.g. nextLine( )

   Replaced StringTokenizer with split method from String class.
   Richard Tresider
   Apr 14 2008

   Note that this implementation assumes that there is no blank line
   at the end of the data files, which is true as at Apr 14 2008
   in csiilib

   All methods, except main, are now non-static
*/
