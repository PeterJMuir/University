...
public class StringRadixSortPeople  
{
   /* Driver program
   ...
   public static void main(String[] args) throws Exception
   {
      ...
      if (args.length != 2)
      {
         System.out.println("Usage: StringRadixSortPeople <input file> <output file>");
         System.exit(1);
      }
