...
public class Catalog
{
	...
	public void updateProductOnSaleStatus(String id, boolean onSale) throws Exception
	{
		Product p = searchProduct(id);
		boolean pre = (p != null);
		if(!pre)
	...
	// from a file into this Catalog instance
	{
		products = new ArrayList<Product>();
	...
	// To provide data to the GUI component
	//
	...
	public static void main(String [] args) throws Exception
	{
		...
		// Restore data file to original state
