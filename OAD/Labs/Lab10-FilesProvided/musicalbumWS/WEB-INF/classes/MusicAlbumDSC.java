...
public class MusicAlbumDSC
{
    ...
    public int count() throws SQLException
    {
	 ...
	 /**
	 	* Add an album record to the database
    ...
    public void add(MusicAlbum musicAlbum) throws Exception
    {
        ...
        // pre-condition:
        // id should NOT EXIST. Throw an exception if it does
 	 ...
 	 /**
 	 	* Update an album record in the database
 	 	* param musicAlbum - A MusicAlbum object that contains details for the record
 	 	* to be updated
 	 	* Throws Exception
	 	*/
    public void update(MusicAlbum musicAlbum) throws Exception
    {
 	 ...
 	 /**
 	 	* Delete an album record from the database
 	 	* param id - The id of the record to be deleted
 	 	* ReturnThe MusicAlbum object representing the deleted record
 	 	* Throws Exception
	 	*/
