...
DROP TABLE EQUIPMENT_HIRE cascade constraints;
...
--EQUIPMENT (EquipmentID, EquipmentName, EquipmentStatus, EFlag, MFlag, InspectionDate, MaxRentDurationDays)
CREATE TABLE EQUIPMENT(
EquipmentID         VARCHAR2(10)  NOT NULL,
EquipmentName 		  VARCHAR2(50),
EquipmentStatus     VARCHAR2(10) CHECK(EquipmentStatus IN('Rented','Available','Overdue')),
EFlag       		    CHAR(1) CHECK(EFlag IN('Y', 'y', 'N', 'n')),
MFlag               CHAR(1) CHECK(MFlag IN('Y', 'y', 'N', 'n')),
InspectionDate      DATE,
MaxRentDurationDays NUMBER(2) NOT NULL,
...
---REVIEWTable (ReviewID, ReviewDate, ReviewRating, ReviewText, JobID)
CREATE TABLE REVIEW(
ReviewID      VARCHAR2(10)  NOT NULL,
ReviewDate    DATE,
ReviewRating  NUMBER(1) CHECK(ReviewRating BETWEEN 0 AND 5),
...
QuoteStatus      VARCHAR2(10)  CHECK(QuoteStatus IN('Selected', 'Contacted', 'Posted')),
...
-- CLIENT (ClientNo, ClientName, ClientAddress, ClientPhone, ClientEmail)
INSERT INTO CLIENT VALUES('1','Kazi Abir', '63 Rosebery Avenue, Preston', '0540677455', 'kazi.abir@gmail.com');
INSERT INTO CLIENT VALUES('2','Kazi Adnan', '63 Rosebery Rd, Preston', '0450677456', 'kazi.adnan@gmail.com');
INSERT INTO CLIENT VALUES('3','Syed Mahbub', '34 Waratah St, Thomastown', '0450672446', 'syed.mahbub@gmail.com');
...
INSERT INTO BUSINESS VALUES('12345678912', 'Consolidated Proerty Services', 'Harun Rashid', '039342354', 'hrashid@cps.com', 'Cr Lonsdale St and Russel St, Melbourne', 3000);
...
INSERT INTO BUSINESS VALUES('12345678926', 'Home Cleaning Services', 'Omid Rostami', '038002333', 'omid@hotmail.com', '40 Statino St, Laverton', 3028);
...
INSERT INTO BUSINESS VALUES('12345678929', 'Gold Cleaning Services', 'Roger Mayers', '045067600', 'rmayers@yahoo.com.au', '50 Wood St, North Melbourne', 3051);
...
INSERT INTO CORPORATE_BUSINESS VALUES('12345678929');
...
INSERT INTO CONTRACT_JOB VALUES('12', TO_DATE('03-MAR-2017', 'DD-MON-YYYY'), TO_DATE('02-MAR-2018', 'DD-MON-YYYY'), '2');
INSERT INTO CONTRACT_JOB VALUES('13', TO_DATE('27-FEB-2017', 'DD-MON-YYYY'), TO_DATE('26-AUG-2017', 'DD-MON-YYYY'), '3');
INSERT INTO CONTRACT_JOB VALUES('14', TO_DATE('15-MAR-2016', 'DD-MON-YYYY'), TO_DATE('14-MAR-2017', 'DD-MON-YYYY'), '4');
...
INSERT INTO CONTRACT_JOB VALUES('17', TO_DATE('01-JAN-2017', 'DD-MON-YYYY'), TO_DATE('31-DEC-2019', 'DD-MON-YYYY'), '7');
INSERT INTO CONTRACT_JOB VALUES('18', TO_DATE('06-JUN-2017', 'DD-MON-YYYY'), TO_DATE('05-DEC-2017', 'DD-MON-YYYY'), '8');
INSERT INTO CONTRACT_JOB VALUES('19', TO_DATE('02-MAR-2017', 'DD-MON-YYYY'), TO_DATE('01-MAY-2017', 'DD-MON-YYYY'), '9');
...
--QUOTATION (JobID, ABNNumber, QuoteAmount, QuoteStatus)
INSERT INTO QUOTATION VALUES('1', '12345678923', 100.00, 'Selected');
INSERT INTO QUOTATION VALUES('2', '12345678923', 80.00, 'Posted');
INSERT INTO QUOTATION VALUES('3', '12345678913', 300.00, 'Posted');
INSERT INTO QUOTATION VALUES('3', '12345678925', 280.00, 'Selected');
INSERT INTO QUOTATION VALUES('4', '12345678913', 250.00, 'Contacted');
INSERT INTO QUOTATION VALUES('7', '12345678926', 100.00, 'Selected');
INSERT INTO QUOTATION VALUES('8', '12345678923', 400.00, 'Selected');
INSERT INTO QUOTATION VALUES('9', '12345678922', 150.00, 'Posted');
INSERT INTO QUOTATION VALUES('10', '12345678927', 700.00, 'Selected');
INSERT INTO QUOTATION VALUES('11', '12345678912', 3000.00, 'Contacted');
INSERT INTO QUOTATION VALUES('12', '12345678916', 10000.00, 'Contacted');
INSERT INTO QUOTATION VALUES('12', '12345678921', 12000.00, 'Selected');
INSERT INTO QUOTATION VALUES('13', '12345678916', 15000.00, 'Selected');
INSERT INTO QUOTATION VALUES('14', '12345678919', 7000.00, 'Selected');
INSERT INTO QUOTATION VALUES('14', '12345678920', 7500.00, 'Contacted');
INSERT INTO QUOTATION VALUES('15', '12345678914', 20000.00, 'Selected');
INSERT INTO QUOTATION VALUES('15', '12345678915', 22500.00, 'Posted');
INSERT INTO QUOTATION VALUES('16', '12345678919', 12000.00, 'Contacted');
INSERT INTO QUOTATION VALUES('16', '12345678920', 13000.00, 'Selected');
INSERT INTO QUOTATION VALUES('17', '12345678919', 33000.00, 'Contacted');
INSERT INTO QUOTATION VALUES('17', '12345678920', 31500.00, 'Selected');
INSERT INTO QUOTATION VALUES('18', '12345678919', 7800.00, 'Selected');
INSERT INTO QUOTATION VALUES('19', '12345678912', 2800.00, 'Selected');
INSERT INTO QUOTATION VALUES('20', '12345678928', 4500.00, 'Contacted');
...
INSERT INTO BUSINESS_INDUSTRY VALUES('12345678929', '1');
...
---REVIEWTable (ReviewID, ReviewDate, ReviewRating, ReviewText, JobID)
INSERT INTO REVIEW VALUES('1', TO_DATE('01-JAN-2017', 'DD-MON-YYYY'), 4, 'Job well done. My lawn looks clean and the rubbish was taken away.', '1');
INSERT INTO REVIEW VALUES('2', TO_DATE('15-JAN-2017', 'DD-MON-YYYY'), 3, 'Happy with the service, could be better as I found a scratch at the back of my fridge after the move. ', '3');
INSERT INTO REVIEW VALUES('3', TO_DATE('20-JAN-2017', 'DD-MON-YYYY'), 5, 'Nicely done! Very professional', '7');
INSERT INTO REVIEW VALUES('4', TO_DATE('21-FEB-2017', 'DD-MON-YYYY'), 2, 'Poorly done job, the newly designed landscape was very disorganized', '8');
INSERT INTO REVIEW VALUES('5', TO_DATE('03-MAR-2017', 'DD-MON-YYYY'), 4, 'Quick and efficient plumbing', '10');


--SEMINAR (SeminarID, SeminarTitle, SeminarDataTime, SeminarVenue)
INSERT INTO SEMINAR VALUES('1', 'Career Development for Construction Workers.', TO_DATE('12-FEB-2017 10:00', 'DD-MON-YYYY HH24:MI'), 'Convention Hall, Bundoora, 3083');
INSERT INTO SEMINAR VALUES('2', 'Ray White Career Seminar for Construction Workers', TO_DATE('28-FEB-2017 11:00', 'DD-MON-YYYY HH24:MI'), 'Convention Hall, Bundoora, 3083');
INSERT INTO SEMINAR VALUES('3', 'Career Fair for Plumbing Workers', TO_DATE('05-MAR-2017 14:00', 'DD-MON-YYYY HH24:MI'), 'Local Counsil Office, Epping, 3076');
INSERT INTO SEMINAR VALUES('4', 'Cleaners Counsil Seminar', TO_DATE('15-MAR-2017 13:00', 'DD-MON-YYYY HH24:MI'), 'CLT, Melbourne Polytechnic, Preston, 3072');
...
--EQUIPMENT (EquipmentID, EquipmentName, EquipmentStatus, EFlag, MFlag, InspectionDate, MaxRentDurationDays)
INSERT INTO EQUIPMENT VALUES('1', 'Lawn Mower S300', 'Available', 'Y', 'N', TO_DATE('31-DEC-2017', 'DD-MON-YYYY'), 5);
INSERT INTO EQUIPMENT VALUES('2', 'Lawn Mower S300', 'Available', 'Y', 'N', TO_DATE('31-DEC-2017', 'DD-MON-YYYY'), 5);
INSERT INTO EQUIPMENT VALUES('3', 'Lawn Mower S300', 'Available', 'Y', 'N', TO_DATE('31-DEC-2017', 'DD-MON-YYYY'), 5);
INSERT INTO EQUIPMENT VALUES('4', 'Lawn Mower S300', 'Available', 'Y', 'N', TO_DATE('31-DEC-2017', 'DD-MON-YYYY'), 5);
INSERT INTO EQUIPMENT VALUES('5', 'Lawn Mower S300', 'Overdue', 'Y', 'N', TO_DATE('31-DEC-2017', 'DD-MON-YYYY'), 5);
INSERT INTO EQUIPMENT VALUES('6', 'Lawn Mower S300 Dual-Power', 'Available', 'Y', 'Y', TO_DATE('31-DEC-2017', 'DD-MON-YYYY'), 5);
INSERT INTO EQUIPMENT VALUES('7', 'Lawn Mower S300 Dual-Power', 'Available', 'Y', 'Y', TO_DATE('31-DEC-2017', 'DD-MON-YYYY'), 5);
INSERT INTO EQUIPMENT VALUES('8', 'Carpet Steam Cleaner-C100', 'Available', 'N', 'Y', NULL, 10);
INSERT INTO EQUIPMENT VALUES('9', 'Carpet Steam Cleaner-C200', 'Available', 'N', 'Y', NULL, 10);
INSERT INTO EQUIPMENT VALUES('10', 'Carpet Steam Cleaner-C300', 'Available', 'N', 'Y', NULL, 10);
INSERT INTO EQUIPMENT VALUES('11', 'Miele Hardwood Vacuum Cleaner M150', 'Available', 'Y', 'N', TO_DATE('30-JUN-2017', 'DD-MON-YYYY'), 14);
INSERT INTO EQUIPMENT VALUES('12', 'Miele Carpet Vacuum Cleaner M150', 'Available', 'Y', 'N', TO_DATE('30-JUN-2017', 'DD-MON-YYYY'), 14);
INSERT INTO EQUIPMENT VALUES('13', 'Razor HandHeld Vacuum Cleaner R300', 'Rented', 'Y', 'N', TO_DATE('31-AUG-2017', 'DD-MON-YYYY'), 90);
INSERT INTO EQUIPMENT VALUES('14', 'Razor HandHeld Vacuum Cleaner R200', 'Available', 'Y', 'N', TO_DATE('31-AUG-2017', 'DD-MON-YYYY'), 14);
INSERT INTO EQUIPMENT VALUES('15', 'Razor HandHeld Vacuum Cleaner R100', 'Available', 'Y', 'N', TO_DATE('31-AUG-2017', 'DD-MON-YYYY'), 14);


--EQUIPMENT_HIRE (ClientNo, EquipmentID, PickUpDate, DropOffDate)(Data is populated on 28th February, 2017)
INSERT INTO EQUIPMENT_HIRE VALUES('2', '1', TO_DATE('01-FEB-2016', 'DD-MON-YYYY'), TO_DATE('02-FEB-2016', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('1', '2', TO_DATE('27-FEB-2017', 'DD-MON-YYYY'), TO_DATE('28-FEB-2017', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('4', '3', TO_DATE('25-FEB-2017', 'DD-MON-YYYY'), TO_DATE('28-FEB-2017', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('5', '4', TO_DATE('25-DEC-2016', 'DD-MON-YYYY'), TO_DATE('27-DEC-2016', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('5', '5', TO_DATE('01-FEB-2017', 'DD-MON-YYYY'), NULL);
INSERT INTO EQUIPMENT_HIRE VALUES('6', '6', TO_DATE('28-FEB-2017', 'DD-MON-YYYY'), TO_DATE('02-MAR-2017', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('10', '7', TO_DATE('25-JAN-2017', 'DD-MON-YYYY'), TO_DATE('30-JAN-2017', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('11', '8', TO_DATE('27-JAN-2017', 'DD-MON-YYYY'), TO_DATE('28-JAN-2017', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('2', '9', TO_DATE('20-FEB-2017', 'DD-MON-YYYY'), TO_DATE('23-FEB-2017', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('12', '10', TO_DATE('21-FEB-2017', 'DD-MON-YYYY'), TO_DATE('24-FEB-2017', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('13', '12', TO_DATE('10-MAR-2017', 'DD-MON-YYYY'), TO_DATE('13-MAR-2017', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('15', '13', TO_DATE('13-APR-2017', 'DD-MON-YYYY'), NULL);
INSERT INTO EQUIPMENT_HIRE VALUES('1', '1', TO_DATE('01-MAR-2017', 'DD-MON-YYYY'), TO_DATE('02-MAR-2017', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('4', '1', TO_DATE('15-MAR-2017', 'DD-MON-YYYY'), TO_DATE('17-MAR-2017', 'DD-MON-YYYY'));
INSERT INTO EQUIPMENT_HIRE VALUES('2', '3', TO_DATE('12-APR-2017', 'DD-MON-YYYY'), TO_DATE('15-APR-2017', 'DD-MON-YYYY'));
