...
INSERT INTO Events
VALUES
('E00001', 'Accountant''s Annual 2007', 'Local conference on latest trends in accounting', 150, 'Y', 'N', 'Conference', 150.00, 'C00011');
...
INSERT INTO Events
VALUES
('E00011', 'Accountant''s Annual 2008', 'Local conference on latest trends in accounting', 75, 'Y', 'N', 'Conference', 90.00, 'C00011');
...
INSERT INTO Events
VALUES
('E00017', 'The Wizard of Oz', 'The School of Song and Dance presents its 2008 production', 500, 'Y', 'N', 'Concert', 15.00, 'C00009');

INSERT INTO Events
VALUES
('E00018', 'Fame', 'The School of Song and Dance presents its 2009 production', 500, 'Y', 'N', 'Concert', 17.50, 'C00009');

INSERT INTO Events
VALUES
('E00019', 'Accountant''s Annual 2009', 'Local conference on latest trends in accounting', 75, 'Y', 'N', 'Conference', 100, 'C00011');
...
--Tickets sold for event E00001 - Accountants Annual 2007
--No Promoter

EXECUTE InsertTicket(1, 100, TO_DATE('12-JUN-2007 09:30', 'DD-MON-YYYY HH24:MI'), 'E00001', NULL);
...
EXECUTE InsertTicket(1, 200, TO_DATE('29-SEP-2007 19:30', 'DD-MON-YYYY HH24:MI'), 'E00003', 'P00005');

--Tickets sold for event E00004 - Athletics League Awards Evening
--Promoted by P00001 - Walter's Meats and P00002 - Clara's Cafe

EXECUTE InsertTicket(1, 120, TO_DATE('29-APR-2007 19:30', 'DD-MON-YYYY HH24:MI'), 'E00004', 'P00001');
EXECUTE InsertTicket(121, 200, TO_DATE('29-APR-2007 19:30', 'DD-MON-YYYY HH24:MI'), 'E00004', 'P00002');

--Tickets sold for event E00006 - Market Hill Council Christmas Function
--No Promoter

EXECUTE InsertTicket(1, 110, TO_DATE('09-DEC-2007 19:30', 'DD-MON-YYYY HH24:MI'), 'E00006', NULL);
EXECUTE InsertTicket(111, 145, TO_DATE('09-DEC-2007 19:30', 'DD-MON-YYYY HH24:MI'), 'E00006', NULL);

--Tickets sold for event E00007 - Fisherman's Bend Council Christmas Function
--No Promoter

EXECUTE InsertTicket(1, 265, TO_DATE('01-DEC-2008 19:30', 'DD-MON-YYYY HH24:MI'), 'E00007', NULL);

--Tickets sold for event E00008 - Football Fundraiser
--Promoter P00005 - Coffee by the lake, P00001 - Walter's Meats

EXECUTE InsertTicket(1, 175, TO_DATE('24-MAR-2008 19:30', 'DD-MON-YYYY HH24:MI'), 'E00008', 'P00005');
EXECUTE InsertTicket(176, 320, TO_DATE('24-MAR-2008 19:30', 'DD-MON-YYYY HH24:MI'), 'E00008', 'P00001');
...
EXECUTE InsertTicket(1, 50, TO_DATE('15-DEC-2008 19:00', 'DD-MON-YYYY HH24:MI'), 'E00009', 'P00001');
EXECUTE InsertTicket(51, 65, TO_DATE('15-DEC-2008 19:00', 'DD-MON-YYYY HH24:MI'), 'E00009', 'P00002');
EXECUTE InsertTicket(66, 140, TO_DATE('15-DEC-2008 19:00', 'DD-MON-YYYY HH24:MI'), 'E00009', 'P00003');
EXECUTE InsertTicket(141, 180, TO_DATE('15-DEC-2008 19:00', 'DD-MON-YYYY HH24:MI'), 'E00009', 'P00004');

--Tickets sold for event E00010 - High St Traders Christmas Function
EXECUTE InsertTicket(1, 120, TO_DATE('02-DEC-2008 13:00', 'DD-MON-YYYY HH24:MI'), 'E00010', 'P00001');

--Tickets sold for event E00011 - Accountant's Annual 2008
EXECUTE InsertTicket(1, 70, TO_DATE('12-NOV-2008 09:00', 'DD-MON-YYYY HH24:MI'), 'E00011', NULL);

--Tickets sold for event E00012 - Athletics Fundraiser
EXECUTE InsertTicket(1, 150, TO_DATE('14-JUL-2008 19:00', 'DD-MON-YYYY HH24:MI'), 'E00012', 'P00002');
EXECUTE InsertTicket(200, 340, TO_DATE('14-JUL-2008 19:00', 'DD-MON-YYYY HH24:MI'), 'E00012', 'P00003');

--Tickets sold for event E00013 - Macbeth
EXECUTE InsertTicket(1, 150, TO_DATE('13-MAR-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00013', 'P00002');
EXECUTE InsertTicket(1, 180, TO_DATE('14-MAR-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00013', 'P00002');
EXECUTE InsertTicket(1, 200, TO_DATE('15-MAR-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00013', 'P00002');
EXECUTE InsertTicket(300, 450, TO_DATE('13-MAR-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00013', 'P00004');
EXECUTE InsertTicket(300, 520, TO_DATE('14-MAR-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00013', 'P00004');
EXECUTE InsertTicket(300, 580, TO_DATE('15-MAR-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00013', 'P00004');

--Tickets sold for event E00014 - Mimed Moments
EXECUTE InsertTicket(1, 130, TO_DATE('28-FEB-2009 20:00', 'DD-MON-YYYY HH24:MI'), 'E00014', 'P00002');

--Tickets sold for event E00015 - Bopping Ballet
EXECUTE InsertTicket(1, 310, TO_DATE('14-JUN-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00015', 'P00002');

--Tickets sold for event E00016 - Tappin' Tots
EXECUTE InsertTicket(1, 175, TO_DATE('22-JUN-2009 15:00', 'DD-MON-YYYY HH24:MI'), 'E00016', 'P00002');

--Tickets sold for evecnt E00017 - The Wizard of Oz
EXECUTE InsertTicket(1, 350, TO_DATE('20-JUL-2008 19:30', 'DD-MON-YYYY HH24:MI'), 'E00017', 'P00003');
EXECUTE InsertTicket(1, 420, TO_DATE('21-JUL-2008 19:30', 'DD-MON-YYYY HH24:MI'), 'E00017', 'P00003');

--Tickets sold for event E00018 - Fame
EXECUTE InsertTicket(1, 200, TO_DATE('18-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00018', 'P00003');
EXECUTE InsertTicket(1, 240, TO_DATE('19-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00018', 'P00004');
EXECUTE InsertTicket(300, 450, TO_DATE('18-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00018', 'P00003');
EXECUTE InsertTicket(300, 420, TO_DATE('19-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00018', 'P00004');


--Tickets sold for event E00019 - Accountant Annual 2009
EXECUTE InsertTicket(1, 40, TO_DATE('10-NOV-2009 09:00', 'DD-MON-YYYY HH24:MI'), 'E00019', NULL);

--Tickets sold for event E00020 - Romeo and Juliet
EXECUTE InsertTicket(1, 100, TO_DATE('25-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00020', 'P00002');
EXECUTE InsertTicket(1, 150, TO_DATE('26-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00020', 'P00002');
EXECUTE InsertTicket(300, 450, TO_DATE('25-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00020', 'P00004');
EXECUTE InsertTicket(300, 520, TO_DATE('26-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'), 'E00020', 'P00004');

--Tickets sold for event E00022 - Swing Band Night
EXECUTE InsertTicket(1, 55, TO_DATE('27-SEP-2009 20:30', 'DD-MON-YYYY HH24:MI'), 'E00022', 'P00001');
EXECUTE InsertTicket(100, 120, TO_DATE('27-SEP-2009 20:30', 'DD-MON-YYYY HH24:MI'), 'E00022', 'P00002');

--Tickets sold for event E00023 - Baroque Beauty
EXECUTE InsertTicket(1, 5, TO_DATE('16-NOV-2009 12:00', 'DD-MON-YYYY HH24:MI'), 'E00023', 'P00001');
...
VALUES
('E00001', 'V00002', TO_DATE('12-JUN-2007 09:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00002', 'V00004', TO_DATE('14-AUG-2007 09:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00003', 'V00008', TO_DATE('29-SEP-2007 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00004', 'V00006', TO_DATE('29-APR-2007 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00005', 'V00010', TO_DATE('09-OCT-2007 08:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00006', 'V00006', TO_DATE('09-DEC-2007 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00007', 'V00009', TO_DATE('01-DEC-2008 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00008', 'V00008', TO_DATE('24-MAR-2008 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00009', 'V00006', TO_DATE('15-DEC-2008 19:00', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00010', 'V00002', TO_DATE('02-DEC-2008 13:00', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00011', 'V00004', TO_DATE('12-NOV-2008 09:00', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00012', 'V00001', TO_DATE('14-JUL-2008 19:00', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00013', 'V00003', TO_DATE('13-MAR-2009 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00013', 'V00003', TO_DATE('14-MAR-2009 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00013', 'V00003', TO_DATE('15-MAR-2009 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00014', 'V00003', TO_DATE('06-JUN-2009 20:00', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00015', 'V00003', TO_DATE('14-JUN-2009 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00016', 'V00006', TO_DATE('22-JUN-2009 15:00', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00017', 'V00003', TO_DATE('20-JUL-2008 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00017', 'V00003', TO_DATE('21-JUL-2008 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00018', 'V00003', TO_DATE('18-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00018', 'V00003', TO_DATE('19-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00019', 'V00004', TO_DATE('10-NOV-2009 09:00', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00020', 'V00003', TO_DATE('25-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00020', 'V00003', TO_DATE('26-JUL-2009 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00021', 'V00003', TO_DATE('21-NOV-2009 19:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00022', 'V00009', TO_DATE('27-SEP-2009 20:30', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00023', 'V00007', TO_DATE('16-NOV-2009 12:00', 'DD-MON-YYYY HH24:MI'));

INSERT INTO EventVenues
VALUES
('E00024', 'V00007', TO_DATE('11-JAN-2009 20:00', 'DD-MON-YYYY HH24:MI'));
