...
/*         double tempY = radius*Math.sin(alpha);
   ...
   {
	   radius = ((radius+size) < 0)?0:(radius+size);
   }
   
   public String toString()
   {
	   return "circle\n" + super.getRowBase() + " " + super.getColBase() + " " + radius
			   + "\n" + super.getDrawingChar();
   }
   public String toSelectString()
   {
	   return String.format("circle(%d,%d)(%d)(%c)", super.getRowBase(), super.getColBase(), radius, super.getDrawingChar());
   }
}
