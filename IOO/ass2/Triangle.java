...
public class Triangle extends Shape
{
   ...
   {
	   height = ((height+size) < 0)?0:(height+size);
   }
   
   public String toString()
   {
	   return "triangle\n" + super.getRowBase() + " " + super.getColBase() + " " + height
			   + " " + rowIncrement+ " " + colIncrement
			   + "\n" + super.getDrawingChar();
   }
   public String toSelectString()
   {
	   return String.format("triangle(%d,%d)(%d)(%d,%d)(%c)", super.getRowBase(), super.getColBase(), height, rowIncrement, colIncrement, super.getDrawingChar());
   }
}
